...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_rahan_lataaminen_kasvattaa_saldoa_oikein(self):
        self.maksukortti.lataa_rahaa(34)
        self.assertEqual(str(self.maksukortti), "saldo: 0.44")
